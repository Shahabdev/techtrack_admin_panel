...
class _BlockedUserScreenState extends State<BlockedUserScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   }
      //
      //   List<User> blockedUsers = userProvider.users.where((user) => user.isBlocked).toList();
      //   return Column(
      //     children: [
      //       Container(
      ...
      //                 List<User> filteredUsers = blockedUsers
      ...
      //                         ),
      //                         const Expanded(flex: 2, child: TableHeaderText(text: 'ID'))
      //                       ],
      ...
      //                                 Expanded(flex: 2, child: Text(user.id.toString(), textAlign: TextAlign.center)),
      //                               ],
      //                               Expanded(flex: 1, child: Text(user.name.toString(), textAlign: TextAlign.center)),
      //                               Expanded(flex: 1, child: Text(user.dob.toString(), textAlign: TextAlign.center)),
      //                               if (Responsive.isDesktop(context)) Expanded(flex: 1, child: Text(user.country.toString(), textAlign: TextAlign.center)),
      //                               Expanded(
      //                                 flex: 2,
      //                                 child: InkWell(
      //                                   hoverColor: bgColor,
      ...
      //                                   onTap: () async {
      //                                     if (user.isBlocked) {
      //                                       await userProvider.unblockUser(user.id);
      //                                     }
      //                                   },
      //                                 ),
      //                               ),
